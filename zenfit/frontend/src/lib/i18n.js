...
const uz = {
  ...
  home: {
    ...
    todayMeals: "Bugungi ovqatlar", addMeal: "+ Qo'shish", recent: "Yana qo'shish", plannedMeals: "Bugungi reja",
    ...
    qaScan: "AI Skan", qaRecipes: "Ovqatlar", qaProgress: "Statistika", qaTrainer: "AI Trener", qaActivity: "Faollik",
    qaDietPlan: "Dieta rejam", qaWorkoutPlan: "Mashq rejam", qaExercises: "Mashqlar", qaChallenges: "Chellenjlar",
  ...
  workout: {
    ...
    weekN: "{n}-hafta",
    activeProgram: "Faol dastur", openProgram: "Dasturni ochish",
    endProgram: "Dasturni tugatish", programEnded: "Dastur tugatildi",
    programStarted: "Dastur boshlandi 💪",
    programComplete: "Dastur yakunlandi — {weeks} hafta bosib o'tdingiz 🏆",
    otherSection: "Boshqa", history: "Tarix", historyDesc: "Rejalar va bajarilgan mashqlar",
    programsRow: "Tayyor dasturlar", programsRowDesc: "Tayyor haftalik dasturlarni ko'rish",
    newWeek: "Yangi hafta boshlandi",
    newWeekDesc: "Rejani yangilang — bajargan setlaringizga qarab og'irliklar biroz oshiriladi.",
    refreshWeek: "Rejani yangilash", weekRefreshed: "{n}-hafta tayyor 💪",
    finishDay: "Kunni yakunlash", summaryTitle: "Mashq yakuni",
    volume: "Umumiy og'irlik", minutes: "daqiqa", exercisesDone: "Mashqlar",
    noSessionToday: "Bu kunda bajarilgan mashq yo'q",
  ...
  dietPreset: {
    ...
    useThis: "Bu rejani tanlash",
    openRecipe: "Har bir ovqatning yonidagi kitob belgisini bosib, tayyorlash tartibini ko'ring.",
    kcalMeta: "{kcal} kkal • {n} mahal",
  ...
  mealAlert: {
    title: "Diqqat, bu taom yog'li/kaloriyali",
    reasonFat: "Bu taomda yog' ulushi yuqori.",
    reasonCalorie: "Bu taom kunlik me'yoringizning katta qismini oladi.",
    reasonBoth: "Bu taomda ham kaloriya, ham yog' yuqori.",
    delaySentence: "Buni yesangiz, maqsadingiz taxminan {days} kunga cho'ziladi.",
    walkSentence: "Buni sarflash uchun ~{minutes} daqiqa piyoda yuring.",
    logActivity: "Faoliyat qo'shish",
    remindLater: "Eslatmaga qo'shish",
    reminderAdded: "Eslatma qo'shildi — bot ham eslatib turadi",
    debtTitle: "Yoqish kerak: {kcal} kkal",
    dismiss: "Yopish",
  },
...
const ru = {
  ...
  home: {
    ...
    todayMeals: "Приёмы пищи сегодня", addMeal: "+ Добавить", recent: "Добавить снова", plannedMeals: "План на сегодня",
    noMeals: "Пока ничего не добавлено", noMealsDesc: "Отсканируйте блюдо или выберите из рецептов.",
    scanWithAi: "Сканировать с AI",
    qaScan: "AI Скан", qaRecipes: "Еда", qaProgress: "Статистика", qaTrainer: "AI Тренер", qaActivity: "Активность",
    qaDietPlan: "Мой рацион", qaWorkoutPlan: "Мои тренировки", qaExercises: "Упражнения", qaChallenges: "Челленджи",
  ...
  workout: {
    ...
    weekN: "{n}-я неделя",
    activeProgram: "Активная программа", openProgram: "Открыть программу",
    endProgram: "Завершить программу", programEnded: "Программа завершена",
    programStarted: "Программа начата 💪",
    programComplete: "Программа пройдена — {weeks} недель позади 🏆",
    otherSection: "Другое", history: "История", historyDesc: "Планы и выполненные тренировки",
    programsRow: "Готовые программы", programsRowDesc: "Посмотреть готовые недельные программы",
    newWeek: "Началась новая неделя",
    newWeekDesc: "Обновите план — веса немного вырастут по вашим выполненным подходам.",
    refreshWeek: "Обновить план", weekRefreshed: "{n}-я неделя готова 💪",
    finishDay: "Завершить день", summaryTitle: "Итог тренировки",
    volume: "Общий тоннаж", minutes: "мин", exercisesDone: "Упражнения",
    noSessionToday: "В этот день тренировок не было",
  ...
  dietPreset: {
    ...
    use: "Открыть план",
    useThis: "Выбрать этот план",
    openRecipe: "Нажмите на значок книги рядом с блюдом, чтобы увидеть приготовление.",
    kcalMeta: "{kcal} ккал • {n} приёма",
  ...
  mealAlert: {
    title: "Внимание, это блюдо жирное/калорийное",
    reasonFat: "В этом блюде высокая доля жира.",
    reasonCalorie: "Это блюдо занимает большую часть вашей дневной нормы.",
    reasonBoth: "В этом блюде высоки и калории, и жир.",
    delaySentence: "Если съедите это, ваша цель отодвинется примерно на {days} дн.",
    walkSentence: "Чтобы сжечь это, пройдите пешком ~{minutes} мин.",
    logActivity: "Добавить активность",
    remindLater: "Добавить напоминание",
    reminderAdded: "Напоминание добавлено — бот тоже напомнит",
    debtTitle: "Осталось сжечь: {kcal} ккал",
    dismiss: "Закрыть",
  },
