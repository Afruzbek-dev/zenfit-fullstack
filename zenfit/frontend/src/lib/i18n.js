...
const uz = {
  ...
  home: {
    ...
    burnNotCredited: "Ozish maqsadida sarflangan kaloriya kunlik me'yorga qo'shilmaydi — me'yor allaqachon kamaytirilgan.",
...
const ru = {
  ...
  home: {
    ...
    burnNotCredited: "При цели «Похудение» сожжённые калории не добавляются к дневной норме — норма уже рассчитана с дефицитом.",
