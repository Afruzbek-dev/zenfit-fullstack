...
export default {
  ...
  home: {
    ...
    todayMeals: "Today's meals", addMeal: "+ Add", recent: "Log again", plannedMeals: "Today's plan",
    noMeals: "Nothing logged yet", noMealsDesc: "Scan a photo of your food or pick from recipes.",
    scanWithAi: "Scan with AI",
    qaScan: "AI Scan", qaRecipes: "Foods", qaProgress: "Stats", qaTrainer: "AI Trainer", qaActivity: "Activity",
    qaDietPlan: "My diet plan", qaWorkoutPlan: "My workout plan", qaExercises: "Exercises", qaChallenges: "Challenges",
  ...
  workout: {
    ...
    weekN: "Week {n}",
    activeProgram: "Active programme", openProgram: "Open programme",
    endProgram: "End programme", programEnded: "Programme ended",
    programStarted: "Programme started 💪",
    programComplete: "Programme complete — {weeks} weeks done 🏆",
    otherSection: "More", history: "History", historyDesc: "Plans and finished workouts",
    programsRow: "Ready-made programmes", programsRowDesc: "Browse ready weekly programmes",
    newWeek: "A new week has started",
    newWeekDesc: "Refresh the plan — weights step up based on the sets you completed.",
    refreshWeek: "Refresh plan", weekRefreshed: "Week {n} is ready 💪",
    finishDay: "Finish the day", summaryTitle: "Workout summary",
    volume: "Total volume", minutes: "min", exercisesDone: "Exercises",
    noSessionToday: "No workout logged on this day",
  ...
  dietPreset: {
    ...
    use: "Open this plan",
    useThis: "Use this plan",
    openRecipe: "Tap the book icon beside a meal to see how it is prepared.",
    kcalMeta: "{kcal} kcal • {n} meals",
  ...
  mealAlert: {
    title: "Heads up — this meal is heavy",
    reasonFat: "This meal is high in fat.",
    reasonCalorie: "This meal takes up a large share of your daily target.",
    reasonBoth: "This meal is high in both calories and fat.",
    delaySentence: "Eating this pushes your goal back by about {days} days.",
    walkSentence: "Walk about {minutes} min to burn this off.",
    logActivity: "Log an activity",
    remindLater: "Remind me later",
    reminderAdded: "Reminder added — the bot will nudge you too",
    debtTitle: "Still to burn: {kcal} kcal",
    dismiss: "Dismiss",
  },
